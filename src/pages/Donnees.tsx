      ...
      <div className="pt-32 pb-24">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="section-heading mb-6">Données</h1>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3 max-w-4xl mx-auto">
            <div className="bg-muted rounded-lg p-8 text-center">
              <span className="block text-4xl font-serif font-bold text-primary mb-2">42</span>
              <span className="text-muted-foreground">Chiens en activité</span>
            </div>
            <div className="bg-muted rounded-lg p-8 text-center">
              <span className="block text-4xl font-serif font-bold text-primary mb-2">+10 000</span>
              <span className="text-muted-foreground">Victimes accompagnées</span>
            </div>
            <div className="bg-muted rounded-lg p-8 text-center">
              <span className="block text-4xl font-serif font-bold text-primary mb-2">2019</span>
